...
get_sources(){
    ...
    cd debian
    rm -f rules
    wget https://raw.githubusercontent.com/percona/postgres-packaging/14.1/patroni/rules
    rm -f control
    rm -f postinst
    wget https://raw.githubusercontent.com/percona/postgres-packaging/14.1/patroni/control
    ...
    cd rpm
    rm -f patroni.spec
    wget https://raw.githubusercontent.com/percona/postgres-packaging/14.1/patroni/patroni.spec
