...
#   git clone "$REPO" ${PRODUCT_FULL}
    ...
    cd debian
    rm -f rules
    wget https://raw.githubusercontent.com/percona/postgres-packaging/15.1/patroni/rules
    rm -f control
    rm -f postinst
    wget https://raw.githubusercontent.com/percona/postgres-packaging/15.1/patroni/control
    ...
    cd rpm
    rm -f patroni.spec
    wget https://raw.githubusercontent.com/percona/postgres-packaging/15.1/patroni/patroni.spec
