...
#   git clone "$REPO" ${PRODUCT_FULL}
    ...
    cd debian
    rm -f rules
    wget https://raw.githubusercontent.com/${GIT_USER}/postgres-packaging/13.6/patroni/rules
    rm -f control
    rm -f postinst
    wget https://raw.githubusercontent.com/${GIT_USER}/postgres-packaging/13.6/patroni/control
    ...
    cd rpm
    rm -f patroni.spec
    wget https://raw.githubusercontent.com/${GIT_USER}/postgres-packaging/13.6/patroni/patroni.spec
