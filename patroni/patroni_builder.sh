...
#   git clone "$REPO" ${PRODUCT_FULL}
    ...
    cd debian
    rm -f rules
    wget https://raw.githubusercontent.com/percona/postgres-packaging/16.1/patroni/rules
    rm -f control
    rm -f postinst
    ...
    cd rpm
    rm -f patroni.spec
    wget https://raw.githubusercontent.com/percona/postgres-packaging/16.1/patroni/patroni.spec
