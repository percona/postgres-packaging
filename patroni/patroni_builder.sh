...
#   git clone "$REPO" ${PRODUCT_FULL}
    ...
    cd debian
    rm -f rules
    wget https://raw.githubusercontent.com/percona/postgres-packaging/11.19/patroni/rules
    rm -f control
    rm -f postinst
    wget https://raw.githubusercontent.com/percona/postgres-packaging/11.19/patroni/control
    ...
    cd rpm
    rm -f patroni.spec
    wget https://raw.githubusercontent.com/percona/postgres-packaging/11.19/patroni/patroni.spec
