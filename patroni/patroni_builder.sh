...
get_sources(){
    ...
    cd debian
    rm -f rules
    wget https://raw.githubusercontent.com/percona/postgres-packaging/12.3/patroni/rules
    rm -f control
    rm -f postinst
    wget https://raw.githubusercontent.com/percona/postgres-packaging/12.3/patroni/control
    ...
    cd rpm
    wget https://raw.githubusercontent.com/percona/postgres-packaging/12.3/patroni/spec.patch
