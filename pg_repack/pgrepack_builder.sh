...
get_sources(){
    ...
    wget https://raw.githubusercontent.com/sudokamikaze/postgres-packaging/11.12/pg_repack/Makefile.patch
    patch -p0 < Makefile.patch
    rm -rf Makefile.patch
    cd debian
    rm -f rules control control.in
    wget https://raw.githubusercontent.com/sudokamikaze/postgres-packaging/11.12/pg_repack/rules
    wget https://raw.githubusercontent.com/sudokamikaze/postgres-packaging/11.12/pg_repack/control
    wget https://raw.githubusercontent.com/sudokamikaze/postgres-packaging/11.12/pg_repack/control.in
    cd ../
    ...
    mkdir rpm
    cd rpm
    wget https://raw.githubusercontent.com/sudokamikaze/postgres-packaging/11.12/pg_repack/pg_repack.spec
    wget https://raw.githubusercontent.com/sudokamikaze/postgres-packaging/11.12/pg_repack/pg_repack-pg11-makefile-pgxs.patch
    cd ../
    wget https://raw.githubusercontent.com/sudokamikaze/postgres-packaging/11.12/pg_repack/make.patch
    patch -p0 < make.patch
    rm -f make.patch
    cd ${WORKDIR}
    #
