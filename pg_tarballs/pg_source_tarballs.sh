...
export PGBOUNCER_VERSION=1.24.0
export PGPOOL_VERSION=4.5.5
...
PGBACKREST_BRANCH="release/2.54.2"
PGBADGER_BRANCH="v13.0"
PATRONI_BRANCH="v4.0.4"
HAPROXY_BRANCH="v2.8.13"
