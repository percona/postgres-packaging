...
build_curl(){
	...
	export LD_LIBRARY_PATH=${DEPENDENCY_LIBS_PATH}/lib64:${DEPENDENCY_LIBS_PATH}/lib:$LD_LIBRARY_PATH
	./configure --prefix=${DEPENDENCY_LIBS_PATH} --with-ssl=${SSL_INSTALL_PATH} --with-zlib=${DEPENDENCY_LIBS_PATH}
	make
	make install
...
build_proj(){
	...
	build_status "start" "proj"
        ...
        mkdir build
        cd build/
        export LD_LIBRARY_PATH=${DEPENDENCY_LIBS_PATH}/lib:${DEPENDENCY_LIBS_PATH}/lib64:$LD_LIBRARY_PATH
        cmake -DTIFF_LIBRARY=${DEPENDENCY_LIBS_PATH}/lib/libtiff.so -DTIFF_INCLUDE_DIR=${DEPENDENCY_LIBS_PATH}/include -DCURL_LIBRARY=${DEPENDENCY_LIBS_PATH}/lib/libcurl.so -DCURL_INCLUDE_DIR=${DEPENDENCY_LIBS_PATH}/include -DCMAKE_INSTALL_PREFIX=${DEPENDENCY_LIBS_PATH} -DCMAKE_INSTALL_RPATH="${DEPENDENCY_LIBS_PATH}/lib64" ..
        cmake --build . -DTIFF_LIBRARY=${DEPENDENCY_LIBS_PATH}/lib/libtiff.so -DTIFF_INCLUDE_DIR=${DEPENDENCY_LIBS_PATH}/include -DCURL_LIBRARY=${DEPENDENCY_LIBS_PATH}/lib/libcurl.so -DCURL_INCLUDE_DIR=${DEPENDENCY_LIBS_PATH}/include -DCMAKE_INSTALL_PREFIX=${DEPENDENCY_LIBS_PATH} -DCMAKE_INSTALL_RPATH="${DEPENDENCY_LIBS_PATH}/lib64"
...
build_gdal(){
	...
	build_status "start" "gdal"
        ...
        cd build/
        export LD_LIBRARY_PATH=${DEPENDENCY_LIBS_PATH}/lib:${DEPENDENCY_LIBS_PATH}/lib64:$LD_LIBRARY_PATH
        cmake -DCMAKE_INSTALL_PREFIX=${DEPENDENCY_LIBS_PATH} -DCMAKE_INSTALL_RPATH="${DEPENDENCY_LIBS_PATH}/lib64" ..
        cmake --build . -DCMAKE_INSTALL_PREFIX=${DEPENDENCY_LIBS_PATH} -DCMAKE_INSTALL_RPATH="${DEPENDENCY_LIBS_PATH}/lib64"
        cmake --build . --target install -DCMAKE_INSTALL_PREFIX=${DEPENDENCY_LIBS_PATH} -DCMAKE_INSTALL_RPATH="${DEPENDENCY_LIBS_PATH}/lib64"
...
build_libboost(){
	...
	build_status "start" "libboost"
        ...
        cd build/
        export LD_LIBRARY_PATH=${DEPENDENCY_LIBS_PATH}/lib:${DEPENDENCY_LIBS_PATH}/lib64:$LD_LIBRARY_PATH
        cmake -DCMAKE_INSTALL_PREFIX=${DEPENDENCY_LIBS_PATH} -DBUILD_SHARED_LIBS=ON -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_RPATH="${DEPENDENCY_LIBS_PATH}/lib64" ..
        cmake --build . -DCMAKE_INSTALL_PREFIX=${DEPENDENCY_LIBS_PATH} -DBUILD_SHARED_LIBS=ON -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_RPATH="${DEPENDENCY_LIBS_PATH}/lib64"
        cmake --build . --target install -DCMAKE_INSTALL_PREFIX=${DEPENDENCY_LIBS_PATH} -DBUILD_SHARED_LIBS=ON -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_RPATH="${DEPENDENCY_LIBS_PATH}/lib64"
...
build_postgres_server(){
	...
	export LD_LIBRARY_PATH=${DEPENDENCY_LIBS_PATH}/lib:$LD_LIBRARY_PATH
	make
	cd src/backend
	MAKELEVEL=0 make submake-generated-headers
	cd ../..
	MAKELEVEL=0 make -j4 all
	make -j4 -C contrib all
	make -j4 -C contrib/uuid-ossp all
	pushd doc/src
	make all
	popd
	make install
