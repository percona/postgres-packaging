...
get_sources(){
    ...
    mkdir debian
    cd debian/
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/11/pgadmin4/control
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/11/pgadmin4/rules
    chmod +x rules
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/11/pgadmin4/copyright
    echo 9 > compat
    ...
    mkdir rpm
    cd rpm
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/11/pgadmin4/percona-pgadmin4.spec
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/11/pgadmin4/pgadmin4-sphinx-theme.patch
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/11/pgadmin4/pgadmin4-python3-mod_wsgi.conf
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/11/pgadmin4/pgadmin4-python3-mod_wsgi-exports.patch
    cd ${WORKDIR}
    #
...
install_deps() {
    ...
    if [ "x$OS" = "xrpm" ]; then
        ...
        if [ ${RHEL} = 7 ]; then
            yum install -y expect fakeroot httpd-devel percona-postgresql11-devel percona-postgresql-common percona-postgresql-server-dev-all percona-postgresql11-devel python3-devel nodejs yarn rpm-build rpm-sign yum-utils krb5-devel pip3 install sphinx python3-sphinx
        else
            yum install -y expect fakeroot percona-postgresql11-devel percona-postgresql-common percona-postgresql-server-dev-all percona-postgresql11-devel python3-devel nodejs yarn rpm-build rpm-sign yum-utils krb5-devel
            pip3 install sphinx
        fi
    else
