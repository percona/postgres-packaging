...
get_sources(){
    ...
    rm -fr debian rpm
    wget https://raw.githubusercontent.com/percona/postgres-packaging/11.15/pgaudit/all.patch
    patch -p1 < all.patch
    rm -f all.patch
    ...
    wget https://raw.githubusercontent.com/percona/postgres-packaging/11.15/pgaudit/control
    wget https://raw.githubusercontent.com/percona/postgres-packaging/11.15/pgaudit/control.in
    wget https://raw.githubusercontent.com/percona/postgres-packaging/11.15/pgaudit/rules
    ...
    mkdir rpm
    cd rpm
    wget https://raw.githubusercontent.com/percona/postgres-packaging/11.15/pgaudit/pgaudit.spec
    cd ${WORKDIR}
    #
