...
get_sources(){
    ...
    wget https://raw.githubusercontent.com/percona/postgres-packaging/14.10/pgaudit/control
    wget https://raw.githubusercontent.com/percona/postgres-packaging/14.10/pgaudit/control.in
    wget https://raw.githubusercontent.com/percona/postgres-packaging/14.10/pgaudit/all.patch
    wget https://raw.githubusercontent.com/percona/postgres-packaging/14.10/pgaudit/rules
    ...
    mkdir rpm
    cd rpm
    wget https://raw.githubusercontent.com/percona/postgres-packaging/14.10/pgaudit/pgaudit.spec
    cd ${WORKDIR}
    #
