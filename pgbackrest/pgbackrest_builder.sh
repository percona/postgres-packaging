...
get_sources(){
    ...
    rm -f control
    wget https://raw.githubusercontent.com/adivinho/postgres-packaging/12.8/pgbackrest/control
    wget https://raw.githubusercontent.com/adivinho/postgres-packaging/12.8/pgbackrest/compat
    cd ../
    ...
    mkdir rpm
    cd rpm
    wget https://raw.githubusercontent.com/percona/postgres-packaging/12.8/pgbackrest/pgbackrest.spec
    wget https://raw.githubusercontent.com/percona/postgres-packaging/12.8/pgbackrest/pgbackrest.conf
    cd ${WORKDIR}
    #
