...
get_sources(){
    ...
    rm -f control
    wget https://raw.githubusercontent.com/adivinho/postgres-packaging/13.4/pgbackrest/control
    wget https://raw.githubusercontent.com/adivinho/postgres-packaging/13.4/pgbackrest/compat
    cd ../
