...
get_sources(){
    ...
    rm -f control
    wget https://raw.githubusercontent.com/percona/postgres-packaging/15.4/pgbackrest/control
    wget https://raw.githubusercontent.com/percona/postgres-packaging/15.4/pgbackrest/compat
    wget https://raw.githubusercontent.com/percona/postgres-packaging/15.4/pgbackrest/rules.patch
    ...
    mkdir rpm
    cd rpm
    wget https://raw.githubusercontent.com/percona/postgres-packaging/15.4/pgbackrest/pgbackrest.spec
    wget https://raw.githubusercontent.com/percona/postgres-packaging/15.4/pgbackrest/pgbackrest.conf
    cd ${WORKDIR}
    #
...
install_deps() {
    ...
    if [ "x$OS" = "xrpm" ]; then
      ...
      INSTALL_LIST="percona-postgresql15-devel git rpm-build rpmdevtools systemd systemd-devel wget libxml2-devel openssl-devel perl  perl-DBD-Pg perl-Digest-SHA perl-IO-Socket-SSL perl-JSON-PP zlib-devel gcc make autoconf perl-ExtUtils-Embed"
