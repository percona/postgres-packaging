...
get_sources(){
    ...
    rm -f control
    wget https://raw.githubusercontent.com/percona/postgres-packaging/11.20/pgbackrest/control
    wget https://raw.githubusercontent.com/percona/postgres-packaging/11.20/pgbackrest/compat
    wget https://raw.githubusercontent.com/percona/postgres-packaging/11.20/pgbackrest/rules.patch
    ...
    mkdir rpm
    cd rpm
    wget https://raw.githubusercontent.com/percona/postgres-packaging/11.20/pgbackrest/pgbackrest.spec
    wget https://raw.githubusercontent.com/percona/postgres-packaging/11.20/pgbackrest/pgbackrest.conf
    cd ${WORKDIR}
    #
