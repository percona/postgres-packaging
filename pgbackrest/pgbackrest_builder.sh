...
get_sources(){
    ...
    wget https://raw.githubusercontent.com/percona/postgres-packaging/13.0/pgbackrest/control.patch
    ...
    mkdir rpm
    cd rpm
    wget https://raw.githubusercontent.com/percona/postgres-packaging/13.0/pgbackrest/pgbackrest.spec
    wget https://raw.githubusercontent.com/percona/postgres-packaging/13.0/pgbackrest/pgbackrest.conf
    cd ${WORKDIR}
    #
