...
get_sources(){
    ...
    rm -f control
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/11.21/pgbackrest/control
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/11.21/pgbackrest/compat
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/11.21/pgbackrest/rules.patch
    ...
    mkdir rpm
    cd rpm
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/11.21/pgbackrest/pgbackrest.spec
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/11.21/pgbackrest/pgbackrest.conf
    cd ${WORKDIR}
    #
...
install_deps() {
    ...
    if [ "x$OS" = "xrpm" ]; then
      ...
      INSTALL_LIST="percona-postgresql11-devel git rpm-build rpmdevtools systemd systemd-devel wget libxml2-devel openssl-devel perl perl-DBD-Pg perl-Digest-SHA perl-IO-Socket-SSL perl-JSON-PP zlib-devel gcc make autoconf perl-ExtUtils-Embed"
