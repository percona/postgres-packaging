...
get_sources(){
    ...
    wget https://raw.githubusercontent.com/percona/postgres-packaging/13.1/pgbackrest/control.patch
    ...
    mkdir rpm
    cd rpm
    wget https://raw.githubusercontent.com/percona/postgres-packaging/13.1/pgbackrest/pgbackrest.spec
    wget https://raw.githubusercontent.com/percona/postgres-packaging/13.1/pgbackrest/pgbackrest.conf
    cd ${WORKDIR}
    #
