...
get_sources(){
    ...
    rm -f control
    wget https://raw.githubusercontent.com/percona/postgres-packaging/12.8/pgbackrest/control
    wget https://raw.githubusercontent.com/percona/postgres-packaging/12.8/pgbackrest/compat
    cd ../
