...
get_sources(){
    ...
    wget     wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/12.2/pgbackrest/control.patch
    ...
    mkdir rpm
    cd rpm
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/12.2/pgbackrest/pgbackrest.spec
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/12.2/pgbackrest/pgbackrest.conf
    cd ${WORKDIR}
    #
