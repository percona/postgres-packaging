...
get_sources(){
    ...
    rm -f control
    wget https://raw.githubusercontent.com/percona/postgres-packaging/13.2/pgbackrest/control
    cd ../
    ...
    mkdir rpm
    cd rpm
    wget https://raw.githubusercontent.com/percona/postgres-packaging/13.2/pgbackrest/pgbackrest.spec
    wget https://raw.githubusercontent.com/percona/postgres-packaging/13.2/pgbackrest/pgbackrest.conf
    cd ${WORKDIR}
    #
