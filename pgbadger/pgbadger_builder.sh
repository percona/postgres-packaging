...
get_sources(){
    ...
    mkdir debian
    cd debian/
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/13.4/pgbadger/control
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/13.4/pgbadger/rules
    chmod +x rules
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/13.4/pgbadger/copyright
    echo 9 > compat
    ...
    mkdir rpm
    cd rpm
    wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/13.4/pgbadger/percona-pgbadger.spec
    cd ${WORKDIR}
    #
