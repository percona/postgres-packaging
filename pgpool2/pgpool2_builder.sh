...
build_srpm(){
    ...
    --define "pgpool_version ${VERSION}" --define "pg_version ${PG_RELEASE}" --define "pghome /usr/pgsql-${PG_RELEASE}" \
    --define "pgsql_ver ${PG_RELEASE}0" --define "with-pgsql-includedir /usr/pgsql-${PG_RELEASE}/include/" ${WORKDIR}/rpmbuild/SPECS/pgpool.spec
...
build_rpm(){
    ...
    --define "pgpool_version ${VERSION}" --define "pg_version ${PG_RELEASE}" --define "pghome /usr/pgsql-${PG_RELEASE}" \
    --define "pgsql_ver ${PG_RELEASE}0" --define "with-pgsql-includedir /usr/pgsql-${PG_RELEASE}/include/" \
