...
build_srpm(){
    ...
    cd rpmbuild/SOURCES
    wget https://raw.githubusercontent.com/percona/postgres-packaging/${PPG_VERSION}/postgis/postgis-3.3.6.pdf
    #wget --no-check-certificate https://download.osgeo.org/postgis/docs/postgis-3.3.6.pdf
