...
get_sources(){
    ...
    cd debian
        ...
        rm -f rules* control*
        wget https://raw.githubusercontent.com/percona/postgres-packaging/13.10/postgis/rules
        wget https://raw.githubusercontent.com/percona/postgres-packaging/13.10/postgis/control
    ...
    cd rpm
        ...
        wget https://raw.githubusercontent.com/percona/postgres-packaging/13.10/postgis/percona-postgis33.spec
        wget https://raw.githubusercontent.com/percona/postgres-packaging/13.10/postgis/postgis33-3.3.0-gdalfpic.patch
    cd ../
    cd ${WORKDIR}
    #
