...
install_deps() {
    ...
    if [ "x$OS" = "xrpm" ]; then
      ...
      RHEL=$(rpm --eval %rhel)
      ARCH=$(uname -m)
      yum install -y SFCGAL SFCGAL-devel gdal35-devel
