...
get_sources(){
    ...
    cd debian
        ...
        rm -f rules* control*
        wget https://raw.githubusercontent.com/percona/postgres-packaging/14.7/postgis/rules
        wget https://raw.githubusercontent.com/percona/postgres-packaging/14.7/postgis/control
    ...
    cd rpm
        ...
        wget https://raw.githubusercontent.com/percona/postgres-packaging/14.7/postgis/percona-postgis33.spec
        wget https://raw.githubusercontent.com/percona/postgres-packaging/14.7/postgis/postgis33-3.3.0-gdalfpic.patch
    cd ../
    cd ${WORKDIR}
    #
