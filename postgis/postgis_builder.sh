...
get_sources(){
    ...
    cd debian
        ...
        wget https://raw.githubusercontent.com/surbhat1595/postgres-packaging/${PPG_VERSION}/postgis/debian/percona-postgresql-13-postgis-3-scripts.install
        wget https://raw.githubusercontent.com/surbhat1595/postgres-packaging/${PPG_VERSION}/postgis/debian/percona-postgresql-13-postgis-3-scripts.lintian-overrides
        wget https://raw.githubusercontent.com/surbhat1595/postgres-packaging/${PPG_VERSION}/postgis/debian/percona-postgresql-13-postgis-3-scripts.postinst
        wget https://raw.githubusercontent.com/surbhat1595/postgres-packaging/${PPG_VERSION}/postgis/debian/percona-postgresql-13-postgis-3-scripts.prerm
        wget https://raw.githubusercontent.com/surbhat1595/postgres-packaging/${PPG_VERSION}/postgis/debian/percona-postgresql-13-postgis-3.install
        wget https://raw.githubusercontent.com/surbhat1595/postgres-packaging/${PPG_VERSION}/postgis/debian/percona-postgis.install
        wget https://raw.githubusercontent.com/surbhat1595/postgres-packaging/${PPG_VERSION}/postgis/debian/percona-postgresql-13-postgis-3.lintian-overrides
...
install_deps() {
    ...
    if [ "x$OS" = "xrpm" ]; then
      ...
      percona-release enable-only ppg-13.11 testing
      apt-get update
