...
get_sources(){
    ...
    cd debian
        ...
        wget https://raw.githubusercontent.com/percona/postgres-packaging/11.8/postgres-common/control_common.patch
        wget https://raw.githubusercontent.com/percona/postgres-packaging/11.8/postgres-common/maintscripts-functions.patch
        wget https://raw.githubusercontent.com/percona/postgres-packaging/11.8/postgres-common/percona-postgresql-common.templates.patch
        wget https://raw.githubusercontent.com/percona/postgres-packaging/11.8/postgres-common/rules_common.patch
        wget https://raw.githubusercontent.com/percona/postgres-packaging/11.8/postgres-common/supported_versions.patch
    ...
    cd rpm
        ...
        wget https://raw.githubusercontent.com/percona/postgres-packaging/11.8/postgres-common/percona-postgresql-common.spec.patch
