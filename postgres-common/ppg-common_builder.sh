...
get_sources(){
	...
	rm -rf rules control
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/13.5/postgres-common/control
	...
	rm -rf percona-postgresql-common.spec
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/13.5/postgres-common/percona-postgresql-common.spec
    cd ../
    cd ${WORKDIR}
    #
