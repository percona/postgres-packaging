...
get_sources(){
	...
	rm -rf rules control
        wget https://raw.githubusercontent.com/percona/postgres-packaging/12.7/postgres-common/control
        wget https://raw.githubusercontent.com/percona/postgres-packaging/12.7/postgres-common/maintscripts-functions.patch
        wget https://raw.githubusercontent.com/percona/postgres-packaging/12.7/postgres-common/percona-postgresql-common.templates.patch
        wget https://raw.githubusercontent.com/percona/postgres-packaging/12.7/postgres-common/rules
        wget https://raw.githubusercontent.com/percona/postgres-packaging/12.7/postgres-common/supported_versions.patch
	...
	rm -f percona-postgresql-common.spec
        wget https://raw.githubusercontent.com/percona/postgres-packaging/12.7/postgres-common/percona-postgresql-common.spec
    cd ../
    cd ${WORKDIR}
    #
