...
get_sources(){
    ...
    cd debian
        ...
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/12.2/postgres-common/control_common.patch
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/12.2/postgres-common/maintscripts-functions.patch
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/12.2/postgres-common/percona-postgresql-common.templates.patch
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/12.2/postgres-common/rules_common.patch
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/12.2/postgres-common/supported_versions.patch
    ...
    cd rpm
        ...
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/12.2/postgres-common/percona-postgresql-common.spec.patch
