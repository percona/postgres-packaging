...
get_sources(){
	...
	rm -f rules control
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/12.7/postgres/rules
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/12.7/postgres/control
    ...
    cd rpm
        ...
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/12.7/postgres/percona-postgresql-12.spec
    cd ../
    cd ${WORKDIR}
    #
