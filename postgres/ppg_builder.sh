...
get_sources(){
	...
	rm -f rules control
        wget https://raw.githubusercontent.com/percona/postgres-packaging/13.3/postgres/rules
        wget https://raw.githubusercontent.com/percona/postgres-packaging/13.3/postgres/control
    ...
    cd rpm
        ...
        wget https://raw.githubusercontent.com/percona/postgres-packaging/13.3/postgres/percona-postgresql-13.spec
    cd ../
    cd ${WORKDIR}
    #
