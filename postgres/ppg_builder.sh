...
get_sources(){
    ...
    cd deb_packaging
        git checkout -b 11 debian/11.20-1
    cd ../
	...
	rm -f control rules
        wget https://raw.githubusercontent.com/percona/postgres-packaging/11.20/postgres/control
        wget https://raw.githubusercontent.com/percona/postgres-packaging/11.20/postgres/rules
    ...
    cd rpm
        ...
        wget https://raw.githubusercontent.com/percona/postgres-packaging/11.20/postgres/percona-postgresql-11.spec
    cd ../
    cd ${WORKDIR}
    #
