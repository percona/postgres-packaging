...
get_sources(){
	...
	rm -f rules control
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/13.5/postgres/rules
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/13.5/postgres/control
    ...
    cd rpm
        ...
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/13.5/postgres/percona-postgresql-13.spec
    cd ../
    cd ${WORKDIR}
    #
