...
get_sources(){
    ...
    cd deb_packaging
        git checkout -b 11 debian/11.21-1
    cd ../
	...
	rm -f control rules
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/11.21/postgres/control
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/11.21/postgres/rules
    ...
    cd rpm
        ...
        wget https://raw.githubusercontent.com/EvgeniyPatlan/postgres-packaging/11.21/postgres/percona-postgresql-11.spec
    cd ../
    cd ${WORKDIR}
    #
