...
Requires:       percona-postgresql-common > 13.0
Requires:       percona-pgaudit > 13.0
...
%changelog
* Mon Oct 31 2022 Surabhi Bhat <surabhi.bhat> 13.11-1
- Update version for ppg-server meta-package
* Fri Aug 05 2022 Kai Wagner <kai.wagner@percona.com> 13.11-1
- Initial build
