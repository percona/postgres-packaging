...
%changelog
* Thu Oct 27 2022 Surabhi Bhat <surabhi.bhat> 15.2-1
- Update version for ppg-server meta-package
* Wed Jul 20 2022 Kai Wagner <kai.wagner@percona.com> 15.2-1
- Initial build
