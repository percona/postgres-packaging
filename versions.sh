...
case "$1" in
    ...
    pgaudit)
        ...
        PGAUDIT_RPM_RELEASE='7'
        PGAUDIT_DEB_RELEASE='7'
        PGAUDIT_RELEASE='1'
    ...
    postgis33)
        ...
        POSTGIS_PRODUCT_FULL=${POSTGIS_PRODUCT}-${POSTGIS33_VERSION}.${POSTGIS33_RELEASE}
        POSTGIS_SRC_BRANCH="${POSTGIS33_VERSION}.${POSTGIS33_RELEASE}"
